...
| `fallback` | `ReactNode` | `null` | Rendered while loading or redirecting |
| `children` | `ReactNode` | required | Content shown to authenticated users |

## Documentation

Full documentation: [https://eugenioenko.github.io/oidc-js/react/auth-provider/](https://eugenioenko.github.io/oidc-js/react/auth-provider/)
